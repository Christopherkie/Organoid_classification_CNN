    ...
    if filename.endswith(".jpg"):
        ...
        with tf.Session() as sess:
            ...
            for node_id in top_k:
                ...
                # binary
                if "8028" == human_string:
                    y_scores_8028.append(score)
                if "16992" == human_string:
                    y_scores_16992.append(score)
                if "9591" == human_string:
                    y_scores_9591.append(score)
...
# binary
data = pd.DataFrame(np.column_stack([file_names, y_true, y_pred, y_scores_8028, y_scores_9591, y_scores_16992]),
                    columns=['file_names', 'y_true', 'y_pred', 'y_scores_8028', 'y_scores_9591', 'y_scores_16992'])

data.to_csv('data_stage3.csv', index=False, header=['file_names', 'y_true', 'y_pred', 'y_scores_8028', 'y_scores_9591', 'y_scores_16992'])
