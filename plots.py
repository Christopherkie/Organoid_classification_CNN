...
y_pred = df[['y_pred']]
# binary
y_scores_8028 = df[['y_scores_8028']]
y_scores_9591 = df[['y_scores_9591']]
y_scores_16992 = df[['y_scores_16992']]
# multi
'''
...
y_scores_8028 = np.asarray(y_scores_8028)
y_scores_9591 = np.asarray(y_scores_9591)
y_scores_16992 = np.asarray(y_scores_16992)
